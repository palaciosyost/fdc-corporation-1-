        ...
        <div class="model-nav">
            ...
            <div class="descripcion">
                <div class="item">
                    ...
                    <a href=""><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-youtube"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-browser-chrome"
                            viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
